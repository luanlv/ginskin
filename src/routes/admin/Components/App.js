         ...
         <Layout>
          ...
          >
            ...
            >
              ...
              <SubMenu
                key="chinhanh"
                title={<span><Icon type="idcard" /><span className="nav-text">Chi nhánh</span></span>}
              >
                <Menu.Item key="chinhanh1">
                  <Link to="/admin/news?v=list" >Danh sách chi nhánh</Link>
                </Menu.Item>
                <Menu.Item key="chinhanh2">
                  <Link to="#" >Thêm chi nhánh</Link>
                </Menu.Item>
              </SubMenu>
